...
from micropy.stubs.stubs import DeviceStub, StubManager
...
@pytest.fixture
def mock_manager(mocker: MockFixture):
    stubs = [mocker.MagicMock(spec=DeviceStub)]
    mocker.patch.object(StubManager, "_loaded", new=stubs)
    yield stubs
