...
setup(
    ...
    packages=['micropy', 'micropy.data', 'micropy.project', 'micropy.project.modules', 'micropy.stubs', 'micropy.utils'],
    package_dir={"": "."},
