...
setup(
    ...
    package_data={
        "micropy": [
            ...
            "lib/stubber/*.txt",
            "lib/stubber/*.yml",
            "lib/stubber/.github/*.yml",
            "lib/stubber/.github/workflows/*.yml",
            "lib/stubber/.vscode/*.json",
            "lib/stubber/data/*.txt",
            "lib/stubber/data/ignore/*.txt",
            "lib/stubber/data/pycom_ignore/*.txt",
            "lib/stubber/docs/*.yml",
            "lib/stubber/docs/img/*.PNG",
            "lib/stubber/docs/img/*.gif",
            "lib/stubber/docs/img/*.png",
            "lib/stubber/patches/*.patch",
            "lib/stubber/scripts/*.ps1",
            "lib/stubber/src/*.cfg",
            "lib/stubber/src/*.md",
            "lib/stubber/src/*.txt",
        ],
        "micropy.data": ["*.json", "schemas/*.json"],
        "micropy.lib.stubber.tests": [
            "*.md",
            "mocks/micropython-cpython_core/*.md",
            "mocks/pycopy-cpython_core/*.json",
            "mocks/pycopy-cpython_core/*.md",
            "mocks/pycopy-cpython_core/*.pyi",
        ],
        "micropy.project": ["template/*.conf", "template/.vscode/*.json"],
    },
    install_requires=[
        "boltons==19.*,>=19.3.0",
        "cachier==1.*,>=1.2.0",
        "click==7.*,>=7.0.0",
        'colorama==0.*,>=0.4.3; sys_platform == "win32"',
        "dpath<2.0,>=1.4",
        "gitpython==3.*,>=3.1.7",
        "jinja2==2.*,>=2.10.0",
        "jsonschema==3.2.0",
    ...
    extras_require={
        ...
        "dev": [
            ...
            "pytest==6.*,>=6.2.0",
            "pytest-cov==2.*,>=2.11.0",
            "pytest-datadir==1.*,>=1.3.0",
            "pytest-forked==1.*,>=1.3.0",
            "pytest-mock==3.*,>=3.5.0",
            "pytest-randomly==3.*,>=3.7.0",
            "pytest-runner==5.*,>=5.3.0",
            "pytest-sugar==0.*,>=0.9.4",
            "pytest-testmon==1.*,>=1.0.0",
            "pytest-watch==4.*,>=4.2.0",
            "pytest-xdist==1.*,>=1.30.0",
            "requests-mock==1.*,>=1.9.0",
            "rope==0.*,>=0.19.0",
            "tox==3.*,>=3.23.0",
