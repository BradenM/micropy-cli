...
setup(
    ...
    extras_require={"create_stubs": ["pyminifier==2.*,>=2.1.0", "rshell==0.*,>=0.0.26"], "dev": ["autoflake==1.*,>=1.3.0", "autopep8==1.*,>=1.4.0", "bump2version==0.*,>=0.5.11", "codacy-coverage==1.*,>=1.3.0", "coveralls==1.*,>=1.8.0", "doc8==0.*,>=0.8.0", "docformatter==1.*,>=1.3.0", "flake8==3.*,>=3.7.0", "flaky==3.*,>=3.6.1", "isort==4.*,>=4.3.0", "mypy==0.*,>=0.750.0", "pylint==2.*,>=2.4.0", "pytest==5.*,>=5.3.0", "pytest-cov==2.*,>=2.8.0", "pytest-datadir==1.*,>=1.3.0", "pytest-mock==1.*,>=1.12.0", "pytest-randomly==3.*,>=3.1.0", "pytest-runner==5.*,>=5.2.0", "pytest-testmon==1.*,>=1.0.0", "pytest-watch==4.*,>=4.2.0", "pytest-xdist==1.*,>=1.30.0", "recommonmark==0.*,>=0.6.0", "requests-mock==1.*,>=1.7.0", "rope==0.*,>=0.14.0", "sphinx==2.*,>=2.2.0", "sphinx-click==2.*,>=2.3.0", "tox==3.*,>=3.14.0", "tox-gh-actions==0.*,>=0.3.0"]},
)
