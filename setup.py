...
setup(
    ...
    install_requires=['boltons==19.*,>=19.3.0', 'cachier==1.*,>=1.2.0', 'click==7.*,>=7.0.0', 'colorama==0.*,>=0.4.3; sys_platform == "win32"', 'dpath==1.*,>=1.4.0', 'jinja2==2.*,>=2.10.0', 'jsonschema==3.2.0', 'packaging==19.*,>=19.2.0', 'questionary==1.*,>=1.4.0', 'requests==2.*,>=2.22.0', 'requirements-parser==0.*,>=0.2.0', 'rshell==0.*,>=0.0.26', 'tqdm==4.*,>=4.39.0'],
