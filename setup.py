...
setup(
    ...
    packages=['micropy', 'micropy.config', 'micropy.data', 'micropy.packages', 'micropy.project', 'micropy.project.modules', 'micropy.stubs', 'micropy.utils', 'temp.NewProject..micropy.NewProject.microwebsrv2'],
    package_dir={"": "."},
    package_data={"micropy": ["lib/stubber/*.conf", "lib/stubber/*.md", "lib/stubber/.vscode/*.json", "lib/stubber/patches/*.patch", "lib/stubber/runOnPc/*.cfg", "lib/stubber/runOnPc/*.cmd"], "micropy.data": ["*.json", "schemas/*.json"], "micropy.project": ["template/*.conf", "template/.vscode/*.json"], "temp.NewProject..micropy.NewProject.microwebsrv2": ["*.pyi", "libs/*.pyi", "mods/*.pyi"]},
