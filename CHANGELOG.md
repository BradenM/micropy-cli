...
## [5.0.0](https://github.com/BradenM/micropy-cli/compare/v4.2.2...v5.0.0) (2026-06-18)
...
* **deps:** Bump pdbpp to ^0.12.1 to fix CI crash from fancycompleter 0.11 ([cc0849e](https://github.com/BradenM/micropy-cli/commit/cc0849e689f661c07bdcd9bfa70b2f7977ce6a77))
* **deps:** Bump questionary to 2.1.1 to fix `micropy init` crash ([9cd95fb](https://github.com/BradenM/micropy-cli/commit/9cd95fb6b1a5d520a4985eeeae62ab5fdafcd455))
* **deps:** Regenerate poetry.lock and align conflicting constraints ([306c649](https://github.com/BradenM/micropy-cli/commit/306c64981aaa46bed56e07e2ff2f4f3928ce7902))
...
* **deps:** Update dependency click to v8.4.1 ([#626](https://github.com/BradenM/micropy-cli/issues/626)) ([559ce6f](https://github.com/BradenM/micropy-cli/commit/559ce6f4834c6854f7cd1508dfb068c7e409a935))
...
* **deps:** Update dependency distlib to v0.4.0 ([#617](https://github.com/BradenM/micropy-cli/issues/617)) ([bea4581](https://github.com/BradenM/micropy-cli/commit/bea4581545e7fd06c28fc2eed9e63819199db508))
* **deps:** Update dependency distlib to v0.4.1 ([#653](https://github.com/BradenM/micropy-cli/issues/653)) ([5c4e795](https://github.com/BradenM/micropy-cli/commit/5c4e79596027a1cf6eaea2426993ef3fe8629423))
* **deps:** Update dependency distlib to v0.4.3 ([#657](https://github.com/BradenM/micropy-cli/issues/657)) ([cae3a0a](https://github.com/BradenM/micropy-cli/commit/cae3a0ae6f6a3626f5fa5b9598e46b6bbe9c783f))
...
* **deps:** Update dependency micropython-stubber to v1.23.2 ([f361a04](https://github.com/BradenM/micropy-cli/commit/f361a0465c155c11be66da3515358ca25e79dc3e))
* **deps:** Update dependency micropython-stubber to v1.28.3 ([#628](https://github.com/BradenM/micropy-cli/issues/628)) ([ec6681c](https://github.com/BradenM/micropy-cli/commit/ec6681c75c0af5d4bd0ae015e3cb0b2d3dd22de5))
...
* **deps:** Update dependency pydantic to v1.10.26 ([#631](https://github.com/BradenM/micropy-cli/issues/631)) ([3d30cc0](https://github.com/BradenM/micropy-cli/commit/3d30cc0e584e746030acfd8f755c3fe923469b93))
* **deps:** Update dependency python-minifier to v2.11.3 ([#635](https://github.com/BradenM/micropy-cli/issues/635)) ([31784ae](https://github.com/BradenM/micropy-cli/commit/31784ae9f06fbb31a061dce27817c0d12faf5bac))
...
* **deps:** Update dependency requests to v2.34.2 ([#645](https://github.com/BradenM/micropy-cli/issues/645)) ([0f81ebf](https://github.com/BradenM/micropy-cli/commit/0f81ebfba95b7209bad54488b9bff4ce83e7f03b))
* **deps:** Update dependency requests to v2.34.2 [security] ([#629](https://github.com/BradenM/micropy-cli/issues/629)) ([2eed5c5](https://github.com/BradenM/micropy-cli/commit/2eed5c51f93bb1cc15b2fe918de0c91349bfac9b))
* **deps:** Update dependency requirements-parser to v0.13.0 ([#640](https://github.com/BradenM/micropy-cli/issues/640)) ([2eab3c6](https://github.com/BradenM/micropy-cli/commit/2eab3c64c01ea590652ed0692eda1f0bd47b0a9d))
* **deps:** Update dependency requirements-parser to v0.13.1 ([#658](https://github.com/BradenM/micropy-cli/issues/658)) ([e3472d3](https://github.com/BradenM/micropy-cli/commit/e3472d3b82ff6b89533956ed0c4c4e8a5fd95ae2))
...
* **deps:** Update dependency tqdm to v4.68.1 ([#654](https://github.com/BradenM/micropy-cli/issues/654)) ([814b095](https://github.com/BradenM/micropy-cli/commit/814b09567c179813c846dd40dc8366de1a9b28fd))
* **deps:** Update dependency tqdm to v4.68.3 ([#659](https://github.com/BradenM/micropy-cli/issues/659)) ([793993d](https://github.com/BradenM/micropy-cli/commit/793993d7881076818101a26d65dc6cd7b67e5be6))
...
* **deps:** Update dependency typer to v0.26.1 ([#641](https://github.com/BradenM/micropy-cli/issues/641)) ([4f45d6f](https://github.com/BradenM/micropy-cli/commit/4f45d6f8f7a64b5bcd187b7d19954df42f48ada8))
* **deps:** Update dependency typer to v0.26.7 ([#655](https://github.com/BradenM/micropy-cli/issues/655)) ([f79921d](https://github.com/BradenM/micropy-cli/commit/f79921df4ff652b4cbb28e3da78e5e6198ddf965))
...
* **packages:** Recover editable paths from req.line to close BC gaps ([7f4665d](https://github.com/BradenM/micropy-cli/commit/7f4665d64910e8cc3dae4bf533288890a7b31bf5))
* **template:** Emit stub paths under python.analysis.extraPaths for Pylance ([0377cb1](https://github.com/BradenM/micropy-cli/commit/0377cb14fd1387b401ca78a3fa0c5618370babf9))
